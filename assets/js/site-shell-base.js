...
(() => {
  const COPY={
    en:{title:'Powerful on its own. Designed to connect.',body:'Use Wistudi independently or connect it with LMS, identity, content and specialist learning technology.',cta:'Discuss an integration',docs:'Developer Documentation',aria:'Wistudi integration options'},
    vi:{title:'Mạnh mẽ khi hoạt động độc lập. Được thiết kế để kết nối.',body:'Sử dụng Wistudi độc lập hoặc kết nối với LMS, hệ thống định danh, nội dung và công nghệ học tập chuyên biệt.',cta:'Trao đổi về tích hợp',docs:'Tài liệu dành cho nhà phát triển',aria:'Các tùy chọn tích hợp Wistudi'},
    'zh-cn':{title:'独立使用同样强大，也为连接而设计。',body:'可独立使用 Wistudi，也可连接 LMS、身份系统、内容和专业学习技术。',cta:'讨论集成方案',docs:'开发者文档',aria:'Wistudi 集成选项'},
    th:{title:'ทรงพลังด้วยตัวเอง และออกแบบมาเพื่อเชื่อมต่อ',body:'ใช้ Wistudi ได้อย่างอิสระ หรือเชื่อมต่อกับ LMS ระบบยืนยันตัวตน เนื้อหา และเทคโนโลยีการเรียนรู้เฉพาะทาง',cta:'พูดคุยเรื่องการเชื่อมต่อ',docs:'เอกสารสำหรับนักพัฒนา',aria:'ตัวเลือกการเชื่อมต่อ Wistudi'},
    id:{title:'Kuat digunakan sendiri. Dirancang untuk terhubung.',body:'Gunakan Wistudi secara mandiri atau hubungkan dengan LMS, identitas, konten, dan teknologi pembelajaran khusus.',cta:'Diskusikan integrasi',docs:'Dokumentasi Developer',aria:'Opsi integrasi Wistudi'},
    ms:{title:'Berkuasa secara kendiri. Direka untuk berhubung.',body:'Gunakan Wistudi secara kendiri atau hubungkannya dengan LMS, identiti, kandungan dan teknologi pembelajaran khusus.',cta:'Bincangkan integrasi',docs:'Dokumentasi Pembangun',aria:'Pilihan integrasi Wistudi'},
    ar:{title:'قوي بمفرده، ومصمم للاتصال.',body:'استخدم Wistudi بشكل مستقل أو اربطه بأنظمة إدارة التعلم والهوية والمحتوى وتقنيات التعلم المتخصصة.',cta:'ناقش تكاملاً',docs:'وثائق المطورين',aria:'خيارات تكامل Wistudi'}
  };
  ...
  const init=()=>{
    ...
    if(!document.getElementById('ws-integration-banner-style')){
      ...
      style.textContent=`
        ...
        .ws-integration-inner{width:min(calc(100% - 40px),1180px);min-height:126px;margin-inline:auto;display:grid;grid-template-columns:92px minmax(300px,1.2fr) auto auto;gap:22px;align-items:center;padding:18px 0}
        ...
        .ws-integration-actions{display:flex;align-items:center;justify-content:flex-end;gap:9px;white-space:nowrap}
        .ws-integration-cta,.ws-integration-docs{display:inline-flex;align-items:center;justify-content:center;gap:8px;min-height:40px;padding:0 14px;border-radius:12px;font-size:.72rem;font-weight:800;transition:transform .2s ease,box-shadow .2s ease,border-color .2s ease;white-space:nowrap}
        .ws-integration-cta{background:linear-gradient(135deg,#f97316,#fb923c);color:#fff;box-shadow:0 10px 22px rgba(249,115,22,.21)}
        .ws-integration-cta:hover{transform:translateY(-2px);box-shadow:0 14px 28px rgba(249,115,22,.28)}
        .ws-integration-docs{background:#fff;color:#5f2bbd;border:1px solid rgba(124,58,237,.24);box-shadow:0 8px 20px rgba(61,43,101,.06)}
        .ws-integration-docs:hover{transform:translateY(-2px);border-color:rgba(124,58,237,.42);box-shadow:0 12px 26px rgba(61,43,101,.10)}
        .ws-integration-cta svg,.ws-integration-docs svg{width:15px;height:15px;stroke:currentColor;fill:none;stroke-width:2.2}
        @media(max-width:1120px){.ws-integration-inner{grid-template-columns:76px 1fr auto;gap:18px}.ws-integration-main-icon{width:72px;height:72px}.ws-integration-tech{grid-column:2/4;justify-content:flex-start;margin-top:-8px}.ws-integration-actions{grid-column:2/4;justify-content:flex-start}.ws-integration-inner{padding:16px 0}}
        @media(max-width:760px){.ws-integration-inner{width:min(calc(100% - 28px),1180px);grid-template-columns:62px 1fr;gap:13px;min-height:0;padding:16px 0}.ws-integration-main-icon{width:58px;height:58px}.ws-integration-copy h2{font-size:1.05rem}.ws-integration-copy p{font-size:.8rem;line-height:1.48}.ws-integration-tech{grid-column:1/-1;gap:6px;margin:0;overflow-x:auto;padding-bottom:2px;scrollbar-width:none}.ws-integration-tech::-webkit-scrollbar{display:none}.ws-integration-tech-icon{width:40px;height:40px;flex:0 0 40px}.ws-integration-tech-icon img{width:34px;height:34px}.ws-integration-standards{font-size:.62rem}.ws-integration-actions{grid-column:1/-1;display:grid;grid-template-columns:1fr 1fr;width:100%;gap:8px;margin-top:1px}.ws-integration-cta,.ws-integration-docs{min-height:42px;padding:0 10px;font-size:.69rem}}
