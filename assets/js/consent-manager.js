(()=>{
  ...
  const COPY={
    en:{title:'Help us improve Wistudi',body:'We use analytics cookies to understand how this website is used and improve the experience. You can accept analytics or continue without them.',accept:'Accept analytics',reject:'Continue without analytics',settings:'Cookie settings',policy:'Cookie Policy'},
    vi:{title:'Giúp chúng tôi cải thiện Wistudi',body:'Chúng tôi sử dụng cookie phân tích để hiểu cách trang web được sử dụng và cải thiện trải nghiệm. Bạn có thể chấp nhận phân tích hoặc tiếp tục mà không sử dụng chúng.',accept:'Chấp nhận phân tích',reject:'Tiếp tục không phân tích',settings:'Cài đặt cookie',policy:'Chính sách Cookie'},
    'zh-cn':{title:'帮助我们改进 Wistudi',body:'我们使用分析 Cookie 来了解网站的使用方式并改进体验。你可以接受分析，也可以在不启用分析的情况下继续。',accept:'接受分析',reject:'不启用分析并继续',settings:'Cookie 设置',policy:'Cookie 政策'},
    th:{policy:'นโยบายคุกกี้',title:'ช่วยเราปรับปรุง Wistudi',body:'เราใช้คุกกี้เพื่อการวิเคราะห์เพื่อทำความเข้าใจการใช้งานเว็บไซต์และปรับปรุงประสบการณ์ คุณสามารถยอมรับการวิเคราะห์หรือใช้งานต่อโดยไม่เปิดใช้ได้',accept:'ยอมรับการวิเคราะห์',reject:'ใช้งานต่อโดยไม่วิเคราะห์',settings:'การตั้งค่าคุกกี้'},
    id:{title:'Bantu kami meningkatkan Wistudi',body:'Kami menggunakan cookie analitik untuk memahami bagaimana situs ini digunakan dan meningkatkan pengalaman. Anda dapat menerima analitik atau melanjutkan tanpa analitik.',accept:'Terima analitik',reject:'Lanjut tanpa analitik',settings:'Pengaturan cookie',policy:'Kebijakan Cookie'},
    ms:{policy:'Dasar Kuki',title:'Bantu kami menambah baik Wistudi',body:'Kami menggunakan kuki analitik untuk memahami cara laman ini digunakan dan menambah baik pengalaman. Anda boleh menerima analitik atau meneruskan tanpa analitik.',accept:'Terima analitik',reject:'Teruskan tanpa analitik',settings:'Tetapan kuki'},
    ar:{policy:'سياسة ملفات تعريف الارتباط',title:'ساعدنا على تحسين Wistudi',body:'نستخدم ملفات تعريف ارتباط للتحليلات لفهم كيفية استخدام هذا الموقع وتحسين التجربة. يمكنك قبول التحليلات أو المتابعة بدونها.',accept:'قبول التحليلات',reject:'المتابعة بدون تحليلات',settings:'إعدادات ملفات الارتباط'}
  };
  ...
  const show=()=>{
    ...
    banner.innerHTML=`<div class="ws-consent-inner"><div class="ws-consent-copy"><strong>${copy.title}</strong><p>${copy.body} <a href="/cookie-policy/" target="_blank" rel="noopener">${copy.policy||'Cookie Policy'}</a></p></div><div class="ws-consent-actions"><button type="button" class="ws-consent-reject">${copy.reject}</button><button type="button" class="ws-consent-accept">${copy.accept}</button></div></div>`;
